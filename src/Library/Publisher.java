...
public class Publisher extends javax.swing.JFrame {
    ...
    private void addbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addbtnActionPerformed
        ...
        try{
            preparedStatement = connection.prepareStatement("INSERT INTO Publisher(name, address, contact) VALUES (?,?,?)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            preparedStatement = connection.prepareStatement("UPDATE publisher SET name = ?, address = ?, contact = ? WHERE id = ?");
            preparedStatement.setString(1, name);
            preparedStatement.setString(2, address);
            preparedStatement.setString(3, contact);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            preparedStatement = connection.prepareStatement("DELETE FROM publisher WHERE id = ?");
